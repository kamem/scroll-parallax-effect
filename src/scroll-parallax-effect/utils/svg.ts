...
export const strokeDraw = (
  ...
  const e =
    typeof easingName === 'string'
      ? (easing[easingName as keyof typeof easing] as EasingFunction)
      : easingName;
  style.strokeDashoffset = (
    strokeDasharray - e(percent, 0, strokeDasharray, 1)
  ).toString();
};

export const getMaxPathLength = (
  paths?: NodeListOf<SVGGeometryElement> | SVGGeometryElement[]
) => {
