...
var generateScrollStatusValues = function (Vue, opt, $scrollStatus) {
    ...
    if (opt.name) {
        var scrollObj = {
            scrollPosition: _lib_scrollStatus__WEBPACK_IMPORTED_MODULE_1__/* .Status */ .qb.scrollPosition,
            contentSize: _lib_scrollStatus__WEBPACK_IMPORTED_MODULE_1__/* .Status */ .qb.contentSize,
            values: {},
        };
        $scrollStatus[opt.name] = Vue.observable
            ? Vue.observable(scrollObj)
            : (0,vue__WEBPACK_IMPORTED_MODULE_0__.reactive)(scrollObj);
    }
    ...
    return __assign(__assign({}, opt), { updateFunction: function (status) {
            ...
            scrollStatus.values = Object.assign({}, scrollStatus.values, status.functions
                .map(function (_a) {
...
var Parallax = {
    install: function (Vue, opt) {
        ...
        var $scrollStatus = Vue.observable
            ? Vue.observable(scrollObj)
            : (0,vue__WEBPACK_IMPORTED_MODULE_0__.reactive)(scrollObj);
        _lib_scrollStatus__WEBPACK_IMPORTED_MODULE_1__/* .Status */ .qb.setVal(generateScrollStatusValues(Vue, opt, $scrollStatus));
        ...
        Vue.mixin({
            methods: {
                createStatus: function (opt) {
                    ...
                    status.setVal(opt.name
                        ? generateScrollStatusValues(Vue, opt, this.$scrollStatus)
                        : opt);
                    return status;
                },
