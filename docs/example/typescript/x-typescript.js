...
var bird = new _scroll_parallax_effect_index__WEBPACK_IMPORTED_MODULE_0__.ParallaxFit('.bird', [
    {
        start: 0,
        end: '#timing',
        fromStyle: {
...
var birdPath = new _scroll_parallax_effect_index__WEBPACK_IMPORTED_MODULE_0__.ParallaxFit('.birdPath', [
    {
        start: 0,
        end: '#timing',
        fromStyle: {
...
new _scroll_parallax_effect_index__WEBPACK_IMPORTED_MODULE_0__.ParallaxSpeed('.gear', {
    style: 'transform',
...
document.querySelectorAll('.circle').forEach(function (el, i) {
    new _scroll_parallax_effect_index__WEBPACK_IMPORTED_MODULE_0__.ParallaxFit(el, [
        {
            start: ['#fit', -300 + i * 50],
            end: ['#fit', i * 100],
            fromStyle: {
